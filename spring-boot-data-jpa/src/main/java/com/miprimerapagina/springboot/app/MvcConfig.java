...
public class MvcConfig implements WebMvcConfigurer{
	...
	// Registramos nuestro "passwordEncoder" como un componente de Spring (lo
		...
		// Bean que se utiliza en la vista XML para convertir la respuesta (objeto Entity) en un documento XML
		@Bean
		public Jaxb2Marshaller jaxb2Marshaller() {
			Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
			marshaller.setClassesToBeBound(new Class[] {com.miprimerapagina.springboot.app.view.xml.ClienteList.class});
			return marshaller;
		}
